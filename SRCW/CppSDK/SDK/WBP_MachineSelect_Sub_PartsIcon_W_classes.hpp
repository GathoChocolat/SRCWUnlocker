...
// WidgetBlueprintGeneratedClass WBP_MachineSelect_Sub_PartsIcon_W.WBP_MachineSelect_Sub_PartsIcon_W_C
// 0x0020 (0x05B8 - 0x0598)
class UWBP_MachineSelect_Sub_PartsIcon_W_C final : public UMachinePartsScrollBoxItem
{
public:
...
public:
	void ExecuteUbergraph_WBP_MachineSelect_Sub_PartsIcon_W(int32 EntryPoint);
